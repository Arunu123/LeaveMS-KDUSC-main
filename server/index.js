...
const password = encodeURIComponent('yp#BFN@2FqM9Cfj');
const connectionString = `mongodb+srv://kdu:${password}@cluster0.9bluy.mongodb.net/Leave_System?retryWrites=true&w=majority`;
